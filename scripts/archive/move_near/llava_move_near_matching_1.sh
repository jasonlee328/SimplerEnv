...
declare -a arr=("/data/input/jiafei/GroundedVLA/checkpoint/apr1-final-depth-epoch08_cokeceres")
...
/data/input/jiafei/GroundedVLA/SimplerEnv/results/mar31-depth-3-firstact

/data/input/jiafei/GroundedVLA/SimplerEnv/results/results/mar31-depth-3-firstact