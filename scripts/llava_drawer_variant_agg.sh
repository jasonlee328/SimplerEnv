...
# declare -a ckpt_paths=("/gscratch/cse/jason328/checkpoint/checkpoint-109000")

declare -a ckpt_paths=("/gscratch/cse/jason328/checkpoint/unified-3")
declare -a env_names=(
...
EvalSim() {
  ...
  python simpler_env/main_inference.py --policy-model llava --ckpt-path ${ckpt_path} \
